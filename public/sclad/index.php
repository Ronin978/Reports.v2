...
<div id="mainE">
	<div class="table-inline">
		...
		<?php 
				if(empty($_POST["name0"])&&empty($_POST["metric0"])&&empty($_POST["price0"])&&empty($_POST["amount0"]))
				{
					echo
					'<tr>
						<td class="col1">1</td>
	...
	<div id="btnGroup" align="center">		
		<div class="pointer" onclick="AddRow();">Додати</div><br>
	</div>
		...
		<button onclick="document.getElementById('myForm').submit();">Продовжити</button>
		<hr>
